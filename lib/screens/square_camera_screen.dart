                        ...
                        child: ClipRRect(
                          ...
                          child: LayoutBuilder(
                            builder: (context, constraints) {
                              ...
                              // ✅ Fix: invert AR in portrait to avoid stretched preview
                              final isPortrait =
                              ...
                              // We want the preview to cover the square without distortion:
                              // keep aspect ratio, then crop with BoxFit.cover
                              if (previewAR >= 1.0) {
                                // wider than tall
                                childH = side;
