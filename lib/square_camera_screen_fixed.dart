...
class _SquareCameraScreenState extends State<SquareCameraScreen> {
  ...
  Future<void> _captureSquare() async {
    ...
    try {
      ...
      // ✅ Center-crop to square (guaranteed 1:1 output)
      ...
      // ✅ Match training: resize to 640x640 (no stretching since it's already square)
                        ...
                        child: ClipRRect(
                          ...
                          child: LayoutBuilder(
                            builder: (context, constraints) {
                              ...
                              // CameraPreview keeps its own aspect ratio (commonly 4:3 or 16:9).
                              // To avoid black bars AND avoid stretching, we size the child using
                              // the preview's aspect ratio, then use BoxFit.cover to crop.
                              final double side = constraints.maxWidth;
                              final double previewAR = ctrl.value.aspectRatio;
                                  ...
                                  child: SizedBox(
                                    ...
                                    child: Stack(
                                      ...
                                      children: [
                                        ...
                                        // Exposure slider (only if supported)
